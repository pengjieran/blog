...
originContent: >-
  ...
  本文对OAuth 2.0的设计思路和运行流程，做一个简明通俗的解释，主要参考材料为<a
  href="http://www.rfcreader.com/#rfc6749">rfc6749</a>
  ...
  * 客户端模式（client credentials）
  ...
  Location: <a
  href="https://client.example.com/cb">https://client.example.com/cb</a>?code=SplxlOBeZQQYbYS6WxSbIA
  ...
  Location: <a
  href="http://example.com/cb">http://example.com/cb</a>#access_token=2YotnFZFEjr1zCsicMWpAA
